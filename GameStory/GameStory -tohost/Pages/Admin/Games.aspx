<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Games.aspx.cs" Inherits="GameStory.Pages.Admin.Games"
    MasterPageFile="~/Pages/Admin/Admin.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="GameStory.Models.Game" SelectMethod="GetGames"
        ...
        <EditItemTemplate>
            <tr>
                <td>
                    <input name="name" value="<%# Item.gName %>" />
