...
namespace GameStory.Controls
{
    public partial class CategoryList : System.Web.UI.UserControl
    {
        ...
        {   //----------
            //--изменение в навигационные ссылки на категории, связанное с подсветкой 
            //--текущей выбранной категории — это не только визуально подкрепит факт щелчка на одной из ссылок
            ...
            return string.Format("<a href='{0}'>{1}</a>",
                path, category);
            //== selectedCategory ? "class='selected'" : "", category);
        }
    }
}